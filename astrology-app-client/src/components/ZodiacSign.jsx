...
const Card = ({ image, title, description }) => {
  return (
    <div
      className="bg-transparent border border-gray-300 shadow-lg rounded-lg p-6 m-4 flex flex-col items-center transition-transform transform hover:scale-105 duration-300"
    >
      <img
        src={image}
        alt={title}
        className="w-24 h-24 mb-4 opacity-75 invert"
      />
...
const ZodiacSign = () => {
  return (
    <div
      className="p-6 bg-gradient-to-r from-gray-900 to-black text-white"
    ...
    >
      ...
      <p className="text-center mb-8 max-w-2xl mx-auto">
        Discover the mysteries of the zodiac and how your star sign influences
        your personality, relationships, and life path. Explore the unique
        characteristics of each sign and gain insights into your own traits and
        tendencies.
      </p>
      <div
