...
const AstrologyComponent = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between items-center px-4 sm:px-6 lg:px-20 py-12 sm:py-16 bg-gradient-to-r from-gray-900 to-black text-white">
      <div className="w-full lg:w-1/2 p-4 sm:p-6 lg:p-12 flex flex-col justify-center" style={{ fontFamily: "Kanit, sans-serif" }}>
        <p className="text-base sm:text-lg lg:text-xl font-semibold mb-4">Unlimited Guide to Astrology</p>
        <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold mb-4">Your Star Determines</h1>
        <p className="text-2xl sm:text-3xl lg:text-5xl font-bold mb-6">Your Life's Journey</p>
        <p className="text-sm sm:text-base lg:text-md mb-8 py-2">
      ...
      <div className="w-full lg:w-1/2 flex justify-center lg:justify-end mt-8 lg:mt-0">
        <img src={astrologyImage} alt="Astrology" className="w-3/4 sm:w-2/3 lg:w-full max-w-sm lg:max-w-sm rounded-lg transform transition duration-500 hover:scale-105 invert" />
      </div>
    </div>
  );
}
